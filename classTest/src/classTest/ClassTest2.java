...
class Person {
	...
	public Person(String personName, long personMoney) {
...
public class ClassTest2 {
	...
	System.out.println(guehyeok.personMoney);
	System.out.println(kb.bankMoney);
	}
}
